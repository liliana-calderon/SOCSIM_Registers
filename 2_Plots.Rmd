...
load("Output/reference_table_SweBorn")
load("Output/N_Cohort")
load("Output/temp")
...
PlotT
```
### There might be a problem with population size as all the counts are underestimated for recent periods