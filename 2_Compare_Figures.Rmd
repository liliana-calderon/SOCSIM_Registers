---
title: "Kinship networks over time: comparing Swedish population registers and microsimulation outputs. (With no heterogeneous fertility)"
author: '...'
date: "`r Sys.Date()`"
output:
  github_document:
...
load("Output_hetfert0/reference_table_SweBorn.RData")
load("Output_hetfert0/N_Cohort.RData")
load("Output_hetfert0/temp.RData")
...
Fig8a_Diff <- data.frame(Cohort = seq(1920, 2010, 10), 
  ...
  labs(x = "Birth cohort", y = "Difference in the percentage with the median number of kin by cohort")+
  theme_bw() +
  theme(panel.grid.major.y = element_line(colour ="#B3B3B3", linewidth = 0.3, linetype = 9),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.y = element_line(colour ="#B3B3B3", linewidth = 0.3, linetype = 9),
