---
title: "Empirical and microsimulated kinship networks. Comparing and evaluating estimates on micro-level
data on kin relations for the Swedish population"
author: '...'
date: "`r Sys.Date()`"
# output:
#   github_document:
...
knitr::opts_chunk$set(warning= FALSE, message=FALSE, echo = FALSE,
                      fig.align='center', 
                      fig.width=10, fig.fullwidth=TRUE)
```
...
load("Output_/temp.RData")
source("Functions/Functions_Graphs.R")

```

```{r Import register data}
...
Fig1b_SOCSIM <- ggplot() +
  ...
  labs(x = "Birth Cohort \n (Age in 2017)", y = "Average Number of Grandchildren", fill = "") +
...
Fig1b_Diff <- left_join(SKU %>% 
  ...
  scale_color_manual(values = c("#225EA8", "#7FCDBB"), 
                    limits = c("FALSE", "TRUE"), 
                    labels = c("Deceased grandchildren", "Living grandchildren")) +
  labs(x = "Birth Cohort \n (Age in 2017)", y = "Average Number of Grandchildren (SOCSIM-Registers)", color = "") +
  scale_x_continuous(breaks   = c(seq(1920, 2010,by = 10), 2017), labels = paste(c(seq(1920, 2010,by = 10), 2017), "\n", "(",2017 - c(seq(1920, 2010,by = 10), 2017),")")) +
  theme_bw() + theme_graphs2() +
  guides(color = guide_legend(reverse = TRUE))

plot_grid(Fig1b_SOCSIM, Fig1b_SKU, align = "hv")
ggsave(file="Graphs/Fig1b.jpg", width=17, height=9, dpi=200)
Fig1b_Diff
ggsave(file="Graphs/Fig1b_Diff.jpg", width=17, height=9, dpi=200)
```
...
Fig1a_Diff <- left_join(SKU %>% 
  ...
  geom_vline(xintercept = c(2017-73), color = "#000000", lty = 2) +
  facet_wrap(~ Kon, labeller = labeller(Kon = c("1" = "Men", "2" = "Women")), ncol = 1, scales = "free_x", strip.position = "top") +
  labs(x = "Birth Cohort \n (Age in 2017)", y = "Proportion (SOCSIM-Registers)", color = "")+
...
ggsave(file="Graphs/Fig1a.jpg", width=17, height=9, dpi=200)
Fig1a_Diff
ggsave(file="Graphs/Fig1a_Diff.jpg", width=17, height=9, dpi=200)
```
...
Fig2b_Diff <- left_join(SKU %>% 
  ...
  scale_color_manual(values = c("#7FCDBB","#41B6C4", "#225EA8","#FFE6CC"), 
                    limits = c("1", "2", ">2","not living"), 
                    labels = c("One childbearing partner","Two childbearing partners","Three or more childbearing partners","Deceased children")) +
  labs(x = "Birth Cohort \n(Age in 2017)", y = "Average Number of Children (SOCSIM-Registers)", color = " ") +
  scale_x_continuous(breaks   = c(seq(1920, 2010,by = 10), 2017), labels = paste(c(seq(1920, 2010,by = 10), 2017), "\n", "(",2017 - c(seq(1920, 2010,by = 10), 2017),")")) +
  scale_y_continuous(breaks = seq(0,2.5, by = 0.5)) +
  theme_bw() + theme_graphs2() +
  theme(legend.key = element_blank(),
...
ggsave(file="Graphs/Fig2b.jpg", width=17, height=9, dpi=200)
Fig2b_Diff
ggsave(file="Graphs/Fig2b_Diff.jpg", width=17, height=9, dpi=200)
```
...
ggsave(file="Graphs/Fig2a.jpg", width=17, height=9, dpi=200)
Fig2a_Diff
ggsave(file="Graphs/Fig2a_Diff.jpg", width=17, height=9, dpi=200)
```
...
Fig3_Diff <- left_join(SKU %>% 
  ...
  geom_line(aes(x = IDbirthYear, y = Difference, color = Type), linewidth =1) +
  geom_vline(xintercept = c(1940, 2017-46), color = "#000000", lty = 2) +
  labs(x = "Birth Cohort \n(Age in 2017)", y = "Average Number of Nieces and Nephews (SOCSIM-Registers)", 
       color = "") +
...
ggsave(file="Graphs/Fig3.jpg", width=17, height=9, dpi=200)
Fig3_Diff
ggsave(file="Graphs/Fig3_Diff.jpg", width=17, height=9, dpi=200)
```
...
Fig4a_Diff <- left_join(SKU %>% 
  ...
  scale_color_manual(values = c("#A1DAB4", "#41B6C4", "#225EA8","#FFE6CC"), 
                    ...
                    labels = c("Half siblings on mother's side", "Half siblings on father's side", 
                               "Full siblings", "Deceased siblings")) +
  labs(x = "Birth Cohort \n(Age in 2017)", y = "Average Number of Siblings (SOCSIM-Registers)", color = "") +
  scale_x_continuous(breaks   = c(seq(1920, 2010,by = 10), 2017), labels = paste(c(seq(1920, 2010,by = 10), 2017), "\n", "(",2017 - c(seq(1920, 2010,by = 10), 2017),")")) +
  theme_bw() + theme_graphs2() +
  theme(panel.grid.minor = element_line(colour = "#999999", linewidth = 0.3, linetype = 9)) +
...
ggsave(file="Graphs/Fig4a.jpg", width=17, height=9, dpi=200)
Fig4a_Diff
ggsave(file="Graphs/Fig4a_Diff.jpg", width=17, height=9, dpi=200)
```
...
ggsave(file="Graphs/Fig4b.jpg", width=17, height=9, dpi=200)
Fig4b_Diff
ggsave(file="Graphs/Fig4b_Diff.jpg", width=17, height=9, dpi=200)
```
...
Fig5b_Diff <- left_join(SKU %>% 
  ...
  scale_color_manual(values = c("#FFE6CC", "#253494", "#2C7FB8", "#41B6C4", "#A1DAB4"), 
                    ...
                    labels = c("Deceased cousins", "Paternal uncle's side","Paternal aunt's side", 
                               "Maternal uncle's side","Maternal aunt's side")) +
  labs(x = "Birth Cohort \n(Age in 2017)", y = "Average Number of Cousins (SOCSIM-Registers)", color = "") +
  scale_x_continuous(breaks   = c(seq(1920, 2010,by = 10), 2017), labels = paste(c(seq(1920, 2010,by = 10), 2017), "\n", "(",2017 - c(seq(1920, 2010,by = 10), 2017),")")) +
  theme_bw() + theme_graphs2() +
  theme(panel.grid.minor = element_line(colour = "#999999", linewidth = 0.3, linetype = 9)) +
...
ggsave(file="Graphs/Fig5b.jpg", width=17, height=9, dpi=200)
Fig5b_Diff
ggsave(file="Graphs/Fig5b_Diff.jpg", width=17, height=9, dpi=200)
```
...
ggsave(file="Graphs/Fig5a.jpg", width=17, height=9, dpi=200)
Fig5a_Diff
ggsave(file="Graphs/Fig5a_Diff.jpg", width=17, height=9, dpi=200)
```
...
ggsave(file="Graphs/Fig6a.jpg", width=17, height=9, dpi=200)
Fig6a_Diff
ggsave(file="Graphs/Fig6a_Diff.jpg", width=17, height=9, dpi=200)
```
...
Fig6b_Diff <- left_join(SKU %>% 
  ...
  geom_line(aes(x = IDbirthYear, y = Difference, color = Type), linewidth =1) +
  geom_vline(xintercept = c(1977), color = "#000000", lty = 2) +
  labs(x = "Birth Cohort \n(Age in 2017)", y = "Average Number of Aunts and Uncles (SOCSIM-Registers)", color = "") +
  scale_color_manual(values = c("#FFE6CC", "#A1DAB4", "#41B6C4", "#2C7FB8", "#253494"), 
                    limits = c("registered deceased", "father brother", "father sister", "mother brother", "mother sister"),
                    labels = c("Deceased parental siblings", "Paternal uncle", "Paternal aunt", "Maternal uncle", "Maternal aunt")) +
  scale_x_continuous(breaks   = c(seq(1920, 2010,by = 10), 2017), labels = paste(c(seq(1920, 2010,by = 10), 2017), "\n", "(",2017 - c(seq(1920, 2010,by = 10), 2017),")")) +
...
ggsave(file="Graphs/Fig6b.jpg", width=17, height=9, dpi=200)
Fig6b_Diff
ggsave(file="Graphs/Fig6b_Diff.jpg", width=17, height=9, dpi=200)
...
ggsave(file="Graphs/Fig7.jpg", width=17, height=9, dpi=200)
Fig7_Diff
ggsave(file="Graphs/Fig7_Diff.jpg", width=17, height=9, dpi=200)
...
Fig8a_Diff <- data.frame(Cohort = seq(1920, 2010, 10), 
  ...
  labs(x = "Birth Cohort \n (Age in 2017)", y = "Difference in the percentage with the median number of kin by cohort")+
  theme_bw() + theme_graphs2() +
  theme(panel.grid.major.y = element_line(colour = "#999999", linewidth = 0.3, linetype = 9),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.y = element_line(colour = "#999999", linewidth = 0.3, linetype = 9),
...
# Import violin plots from the Swedish Kinship Universe
Fig8a_SKU <- ggdraw() + draw_image('Fig8a_SKU.png')

plot_grid(Fig8a_SOCSIM, Fig8a_SKU, align = "hv",
          rel_heights = c(1.4,0.4), 
          rel_widths = c(0.5,0.5), 
          scale(c(0.7, 0.5)))
ggsave(file="Graphs/Fig8a.jpg", width=17, height=9, dpi=200)
Fig8a_Diff
ggsave(file="Graphs/Fig8a_Diff.jpg", width=17, height=9, dpi=200)
...
ggsave(file="Graphs/Fig8b.jpg", width=17, height=9, dpi=200)
Fig8b_Diff
ggsave(file="Graphs/Fig8b_Diff.jpg", width=17, height=9, dpi=200)
```