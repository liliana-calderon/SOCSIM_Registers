---
title: "Assessing the validity of register-based and microsimulated kinship networks for demographic research"
author: '...'
date: "`r Sys.Date()`"
output:
  github_document:
...
Fig_Diff_All <- full_join(SKU %>% 
  ...
  filter(!is.na(Difference)) %>%
  ggplot() +
  geom_tile(aes(x = IDbirthYear, y = Type, fill = Difference), color = "white") +
  labs(x = "Birth Cohort \n(Age in 2017)", y = "Type of Kin", fill = "Difference") + 
    scale_fill_gradient2(low = "#7A0005", mid = "#FFFFFF", high = "#007A75", midpoint = 0, limits = c(-1.4, 33), oob = scales::squish) +
  scale_x_continuous(breaks = c(seq(1920, 2010, by = 10), 2017), 
                     labels = paste(c(seq(1920, 2010, by = 10), 2017), "\n", "(", 2017 - c(seq(1920, 2010, by = 10), 2017), ")")) +
  theme_bw() + theme_graphs2() +
...
Fig_Diff_All
ggsave(file="Graphs/Fig_Diff_All.pdf", dpi=300, device = "pdf")
```